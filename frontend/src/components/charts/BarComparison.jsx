...
/**
 * BarComparison - Recharts grouped bar chart.
 *
 * Props:
 *   data   - Array of objects
 *   xKey   - Key for x-axis categories
 *   bars   - Array of { key, color?, label }
...
export default function BarComparison({
  ...
  const barConfigs = bars || [{ key: "value", color: CHART_COLORS[0], label: "Value" }];
